...
class derivedclass:public baseclass{
    ...
    int varderived;
    void display(){
        cout<<"displaying base class variable varbase1 "<<varbase<<endl;
...
int main(){
    ...
    //baseclasspointer->varderived=7;     //this will throw error as base class pointer cannot asses derived class properties
